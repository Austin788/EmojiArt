...
struct EmojiArtDocumentView: View {
    ...
    var body: some View {
        VStack {
            ...
            GeometryReader { geometry in
                ZStack{
                    ...
                    if self.isLoading {
                        Image(systemName: "timer").imageScale(.large).spanning()
                    } else {
        ...
        .alert(isPresented: self.$confirmBackgroundPaste) {
            return Alert(
                title: Text("Paste Background"),
                message: Text("Replace your background image"),
    ...
    func zoomGesture() -> some Gesture {
        MagnificationGesture()
            .updating($gestureZoomScale) { latestGestureScale, gestureZoomScale, transiction in
    ...
    private func panGesture() -> some Gesture {
        DragGesture()
            .updating($gesturePanOffset) { latestDragGestureValue, gesturePanOffset, tansaction in
...
//            .updating($gesturePanOffset) { latestDragGestureValue, gesturePanOffset, tansaction in
//                gesturePanOffset = latestDragGestureValue.distance / self.zoomScale
//            }
//            .onEnded { finalDragGestureValue in
